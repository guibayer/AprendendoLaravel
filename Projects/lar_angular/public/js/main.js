...
var PostService = /** @class */ (function () {
    ...
    PostService.prototype.apagar = function (id) {
        var _this = this;
        this.http.delete('/api/delete/' + id).subscribe(function (event) {
            console.log(event);
...
module.exports = __webpack_require__(/*! C:\Users\Guilherme Schneider\Desktop\AprendendoLaravel\Projects\lar_angular\resources\assets\meuapp\src\main.ts */"./src/main.ts");
